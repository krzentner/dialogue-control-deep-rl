# Copied from pycolab, so that I can implement dynamic repainting, so that
# dropped items look like "native" items.
...
def ascii_art_to_game(art,
  ...
  game = game_class(*art.shape, occlusion_in_layers=occlusion_in_layers)
